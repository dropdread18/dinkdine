...
@section('content')
    <h1 class="text-2xl font-semibold text-slate-900 tracking-tight mb-4">Schedule Maintenance</h1>
    ...
    <x-card class="max-w-sm">
        <form method="POST" action="{{ route('admin.maintenance.store') }}" class="space-y-4">
            ...
            <x-button type="submit" class="w-full">Schedule Maintenance</x-button>
