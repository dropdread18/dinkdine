...
<div>
    <label for="court_number" class="block text-sm font-medium text-gray-700">Court Number</label>
...
<div>
    ...
    <select id="status" name="status" required class="mt-1 block w-full rounded border-gray-300 shadow-sm">
...
<div>
    <label for="court_type" class="block text-sm font-medium text-gray-700">Court Type (optional)</label>
...
<div>
    ...
    <textarea id="description" name="description" rows="3" class="mt-1 block w-full rounded border-gray-300 shadow-sm">{{ old('description', $court?->description) }}</textarea>
</div>

<div>
    <label for="sort_order" class="block text-sm font-medium text-gray-700">Sort Order (optional)</label>
...
<div>
    ...
    @if ($court?->image)
        <img src="{{ \Illuminate\Support\Facades\Storage::url($court->image) }}" alt="{{ $court->name }}" class="w-24 h-24 object-cover rounded mt-1 mb-2">
    @endif
