@php
    ...
    $navItems = array_filter([
        ...
        ['label' => 'Courts', 'route' => 'admin.courts.index', 'pattern' => 'admin.courts.*', 'adminOnly' => true],
        ['label' => 'Maintenance', 'route' => 'admin.maintenance.index', 'pattern' => 'admin.maintenance.*', 'adminOnly' => true],
        ['label' => 'Court Schedule', 'route' => 'manage.courts.schedule', 'pattern' => 'manage.courts.schedule', 'adminOnly' => false],
        ...
        ['label' => 'Settings', 'route' => 'manage.settings.index', 'pattern' => 'manage.settings.*', 'adminOnly' => true],
