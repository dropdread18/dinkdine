                ...
                <div class="flex-1 flex items-center justify-center px-6 py-10 lg:py-12">
                    <div class="w-full max-w-[360px] flex flex-col gap-5">
                        <div class="hidden lg:block">
                            <div class="text-[26px] font-extrabold" style="color: var(--db-ink);">Welcome back</div>
                            <div class="text-sm mt-1" style="color: var(--db-ink-soft);">Log in to manage your bookings.</div>
                        </div>
                        ...
                        <form method="POST" action="{{ route('login') }}" class="flex flex-col gap-4">
                            ...
                            <button type="submit" class="h-12 rounded-lg text-[15px] font-bold" style="background: var(--db-accent); color: var(--db-accent-ink);">Log In</button>

                            <p class="text-sm text-center" style="color: var(--db-ink-soft);">
                                <a href="{{ route('password.request') }}" class="font-semibold">Forgot your password?</a>
                            </p>
                            <p class="text-sm text-center" style="color: var(--db-ink-soft);">
                                No account? <a href="{{ route('register') }}" class="font-semibold">Create one</a>
                            </p>
                        </form>
                    </div>
                </div>
