        ...
        <div class="lg:flex lg:min-h-screen">
            <div class="hidden lg:flex lg:flex-1 lg:flex-col lg:justify-center gap-5 px-16" style="background: var(--db-nav);">
                <div class="flex items-center gap-2.5">
                    ...
                    <span class="text-[22px] font-extrabold text-white">Dink Dine</span>
                </div>
            ...
            <div class="lg:w-[480px] flex flex-col" style="background: var(--db-page-bg);">
                <div class="lg:hidden flex flex-col gap-2" style="background: var(--db-nav); padding: 40px 24px 32px;">
                    ...
                    <div class="text-2xl font-extrabold text-white mt-1">Set a new password</div>
                </div>
                ...
                <div class="flex-1 flex items-center justify-center px-6 py-10 lg:py-12">
                    <div class="w-full max-w-[360px] flex flex-col gap-5">
                        <div class="hidden lg:block">
                            <div class="text-[26px] font-extrabold" style="color: var(--db-ink);">Set a new password</div>
                        </div>
                        ...
                        <form method="POST" action="{{ route('password.store') }}" class="flex flex-col gap-4">
                            ...
                            <div class="flex flex-col gap-1.5">
                                <label for="password" class="text-[13px] font-bold" style="color: var(--db-ink);">New Password</label>
                                <input id="password" name="password" type="password" required
                                       placeholder="••••••••" class="db-input">
                            </div>

                            <div class="flex flex-col gap-1.5">
                                <label for="password_confirmation" class="text-[13px] font-bold" style="color: var(--db-ink);">Confirm New Password</label>
                                <input id="password_confirmation" name="password_confirmation" type="password" required
                                       placeholder="••••••••" class="db-input">
                            </div>

                            <button type="submit" class="h-12 rounded-lg text-[15px] font-bold" style="background: var(--db-accent); color: var(--db-accent-ink);">Reset Password</button>
                        </form>
                    </div>
                </div>
            </div>
